...
LANGUAGES = {
    "en": {
        "welcome": "Welcome to EtchOS 4.1.0 Final",
    ...
    "de": {
        "welcome": "Willkommen bei EtchOS 4.1.0 Final",
    ...
    "fr": {
        "welcome": "Bienvenue sur EtchOS 4.1.0 Final",
...
def MainMenu(stdscr, config):
    ...
    while True:
        ...
        if (key == curses.KEY_UP or key == ord('w') or key == ord('W')) and selected > 0:
            ...
            try:
                # Pass the selected file as an argument if coming from FileManager
                # But MainMenu doesn't know about files. 
                # We need to change how apps are called to support arguments.
