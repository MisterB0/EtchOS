# TODO: Change all Version Numbers to 3.7.1 after testing!
...
# EtchOS 3.7.1 - Terminal User Interface Operating System
...
def main(stdscr):
    ...
    def Menu_En():
        ...
        safe_addstr(9, 0, "│ Please enter the number of your choice:                │")
        safe_addstr(10, 0, "│                                                        │")
        safe_addstr(11, 0, "==========================================================")
        safe_addstr(13, 0, " ")
        stdscr.refresh()
